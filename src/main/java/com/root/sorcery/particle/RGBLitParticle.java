...
public class RGBLitParticle extends SpriteTexturedParticle
{
    ...
    public RGBLitParticle(World world, double x, double y, double z, double vX, double vY, double vZ, IAnimatedSprite spriteSetIn, float r, float g, float b, float a)
    {
